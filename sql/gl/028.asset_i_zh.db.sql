...
UPDATE m_asset_package SET version = "4a29dd9a21f39e7fe00fc3c537fa140127e253eb", pack_num = (SELECT COUNT(*) FROM m_asset_package_mapping WHERE package_key="main") WHERE package_key = "main";
