...
UPDATE m_asset_package SET version = "acba9fed36823db7b69a7efa58cf3525a446791c", pack_num = (SELECT COUNT(*) FROM m_asset_package_mapping WHERE package_key="main") WHERE package_key = "main";
