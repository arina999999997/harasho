...
UPDATE m_asset_package SET version = "56a6e2a3f5553b45a8cd99f417b418367fae8c0a", pack_num = (SELECT COUNT(*) FROM m_asset_package_mapping WHERE package_key="main") WHERE package_key = "main";
