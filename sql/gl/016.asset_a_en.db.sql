...
UPDATE m_asset_package SET version = "527ff47fd9bda3be3158d7f4ced5201cd4662a02", pack_num = (SELECT COUNT(*) FROM m_asset_package_mapping WHERE package_key="main") WHERE package_key = "main";
