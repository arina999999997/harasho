...
UPDATE m_asset_package SET version = "12e631b16792667e021946dfbde1db946bf637d8", pack_num = (SELECT COUNT(*) FROM m_asset_package_mapping WHERE package_key="main") WHERE package_key = "main";
