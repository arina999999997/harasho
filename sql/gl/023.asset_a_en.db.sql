...
UPDATE m_asset_package SET version = "19466bc1a1d8228de2ce05b21efd271f6a97b1ff", pack_num = (SELECT COUNT(*) FROM m_asset_package_mapping WHERE package_key="main") WHERE package_key = "main";
