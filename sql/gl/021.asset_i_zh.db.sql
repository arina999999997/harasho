...
UPDATE m_asset_package SET version = "85603f5b1e0234f2b38dec839d78ceeb016c5a10", pack_num = (SELECT COUNT(*) FROM m_asset_package_mapping WHERE package_key="main") WHERE package_key = "main";
