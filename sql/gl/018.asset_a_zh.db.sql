...
UPDATE m_asset_package SET version = "3253fb01a5493cede87861183b4a085d4bb1538a", pack_num = (SELECT COUNT(*) FROM m_asset_package_mapping WHERE package_key="main") WHERE package_key = "main";
