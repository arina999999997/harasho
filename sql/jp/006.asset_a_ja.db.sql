...
UPDATE m_asset_package SET version = "306cff399d40a5f3305364f8aa07b284d92cc5da", pack_num = (SELECT COUNT(*) FROM m_asset_package_mapping WHERE package_key="main") WHERE package_key = "main";
